...
// 
			   ...
			   this->btn_previous->Click += gcnew System::EventHandler(this, &Main::btn_previous_Click);
			   // 
			   // btn_next
			   // 
			   ...
			   this->btn_next->Click += gcnew System::EventHandler(this, &Main::btn_next_Click);
			   // 
			   // btn_last
			   // 
			   ...
			   this->btn_last->Click += gcnew System::EventHandler(this, &Main::btn_last_Click);
			   // 
			   // pctBx
			   // 
			   ...
			   this->btn_source->Click += gcnew System::EventHandler(this, &Main::btn_source_Click);
			   // 
			   // btn_destination
			   // 
			   ...
			   this->btn_destination->Click += gcnew System::EventHandler(this, &Main::btn_destination_Click);
			   // 
			   // txt_source
			   // 
			   ...
			   this->btn_proceder->Click += gcnew System::EventHandler(this, &Main::btn_proceder_Click);
			   // 
			   // txt_rslt
			   // 
			   ...
			   this->lbl_resultats->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,static_cast<System::Byte>(0)));
